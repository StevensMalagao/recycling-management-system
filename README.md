...
Once the hardware is configured, set up the Python environment to run the desktop application.
...
Create and activate a virtual environment to manage dependencies (on Windows, use venv\Scripts\activate instead):
...
Install the necessary libraries from requirements.txt and run the recycling_app.py script:
